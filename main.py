...
def send_email():
    ...
    from_email = "228r5a0407@cmrec.ac.in"  # Update with your email
    password = "bouf lcbl ochf eiea"  # Update with your email password

    # Create a multipart message
    msg = MIMEMultipart()
    msg['From'] = from_email
    msg['To'] = recipient_email
    msg['Subject'] = "Morning 1st Hour Mismatch - Students Report , Date = " + date + ", Time = " + time.strftime('%I:%M:%S %p')

    body = "Please find the attached attendance report. Kindly verify with the students present in the class."
